...
exports.searchQuery = exports.getUsers = exports.createManyUsers = exports.createUser = void 0;
...
var createManyUsers = function (amount) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = Array(amount)
                    .fill(0)
                    .map(function (_) { return helper_1.randomUser(); });
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, client.connect()];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                database = client.db(config_1.default.db.MONGODB.database);
                collection = database.collection("users");
                return [4 /*yield*/, collection.find({}).sort({ created: -1 }).limit(20).toArray()];
            case 2:
                cursor = _a.sent();
